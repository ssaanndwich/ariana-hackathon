...
const SanityLevel: React.FC<SanityLevelProps> = ({ level }) => {
  const levels = [
    { color: 'bg-green-500', label: '5', threshold: 20 },
    { color: 'bg-yellow-500', label: '4', threshold: 40 },
    { color: 'bg-orange-500', label: '3', threshold: 60 },
    { color: 'bg-red-500', label: '2', threshold: 80 },
    { color: 'bg-red-700', label: '1', threshold: 100 },
  ];
